...
//   SimpleObj_t* obj = static_cast<SimpleObj_t *>(malloc(sizeof (SimpleObj_t)));
...
//           = static_cast<ObjGroup_t *>(objDataArrayAccess(&obj->groups, obj->groups.nextIndex - 1));
//         lastGroup->endFace++;
//       }
//     }
//     #ifdef DEBUG
...
//     ObjGroup_t* group = static_cast<ObjGroup_t *>(objDataArrayAccess(&obj->groups, g));
//     free(group->name);
//   }
...
//       ObjDataArray_t* face = static_cast<ObjDataArray_t *>(objDataArrayAccess(&obj->faces, f));
//       glBegin(GL_POLYGON);
//       int f_c;
//       for (f_c = 0; f_c < face->nextIndex; f_c++) {
//         ObjFaceComponent_t* faceComp = static_cast<ObjFaceComponent_t *>(objDataArrayAccess(face, f_c));
//         ObjVertex_t* vertex
//           = static_cast<ObjVertex_t *>(objDataArrayAccess(&obj->vertices, faceComp->vertexIndex - 1));
//         if (faceComp->normalIndex > 0) {
//           ObjVertexNormal_t* normal
//             = static_cast<ObjVertexNormal_t *>(objDataArrayAccess(&obj->normals, faceComp->normalIndex - 1));
//           glNormal3d(normal->x, normal->y, normal->z);
//         }
//         if (faceComp->texCoordIndex > 0) {
//           ObjTexCoord_t* texCoord
//             = static_cast<ObjTexCoord_t *>(objDataArrayAccess(&obj->texCoords, faceComp->texCoordIndex - 1));
