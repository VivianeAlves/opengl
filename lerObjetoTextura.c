...
drawmodel(void) {
    if (!pmodel) {
       //  pmodel = glmReadOBJ("C:\\Users\\Viviane Alves\\Documents\\Simulador OpenGL\\tutors\\data\\soccerball.obj");
pmodel = glmReadOBJ("C:\\Users\\Viviane Alves\\Documents\\tree.obj");
     //   pmodel = glmReadOBJ("C:\\Users\\Viviane Alves\\CLionProjects\\opengl\\objetos\\powerlines.obj");
        if (!pmodel) exit(0);
        glmUnitize(pmodel);
